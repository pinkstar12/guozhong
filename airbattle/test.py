...
if __package__ is None or __package__ == "":
    ...
    from StrategyPredictor.StrategyPredictor import StrategyPredictor  # type: ignore
    from BattlefieldEnvironment.BattlefieldEnvironment import DroneGNN  # type: ignore
