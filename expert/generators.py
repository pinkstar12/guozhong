...
from expert.expertsystem import create_expert_system_from_config
...
# 导入威胁评估便捷函数
from expert.evalthreat.Mutilair_to_Mutilair import (
    get_optimal_targets_from_state, 
    get_max_threats_from_state
)
from expert.evalthreat.SingleAir_to_MulitMissile import get_max_threat_missile
# 配置日志
# 定义绿色ANSI转义码
GREEN = "\033[32m"
RESET = "\033[0m"
