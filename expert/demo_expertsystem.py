...
from expert.expertsystem import ExpertSystem
...
def create_full_expert_system():
    ...
    try:
        ...
        try:
            ...
            from expert.defend_expertsystem import DefendExpertSystem
...
def main():
    ...
    print(f"\n使用方法:")
    print(f"```python")
    print(f"from expert.expertsystem import ExpertSystem")
    print(f"")
    print(f"# 创建系统")
